class TitleScene extends Phaser.Scene {
    ...
    createLoreScreen() {
        ...
        // Modifiche alla posizione e allo stile del testo
        const text = this.add.text(570, **70**, loreTextContent, {
            ...
            wordWrap: { width: 380 },
            lineSpacing: 15 // Aumentato da 10 a 15
        }).setOrigin(0.5, 0);

        // Modifica alla posizione del pulsante Chiudi per una migliore separazione
        const closeButton = this.add.text(400, **570**, '[ Chiudi ]', {
            fontSize: '24px',
            fill: '#333',
